                ...
                {isEmailMode && (
                    ...
                    >
                        {({ handleChange, handleBlur, handleSubmit, touched, errors, values }) => (
                            <React.Fragment>
                                <Image source={require("../assets/lock.png")} style={{ height: 60, width: '15%', marginBottom: "10%" }} />
                                <Text style={{ color: "#fd9242", marginBottom: 15, alignSelf: 'center', fontFamily: 'montserrat-medium', fontSize: 22, }}> Forgot Password?</Text>
                                <Text style={{ textAlign: 'center', marginHorizontal: 40, marginBottom: 10 }}>Please provide your registered email address so that we can help you reset your password. </Text>
                                <View style={{ flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginBottom: 25 }}>
                                    <View style={{
                                        alignSelf: 'center',
                                        borderColor: '#e6e6e6',
                                        borderWidth: 1,
                                ...
                                <TouchableOpacity
                                    style={{ backgroundColor: theme.$primaryColor, height: 45, width: 45, borderRadius: 100, marginLeft: 10, alignItems: 'center', justifyContent: 'center' }}
                    ...
                    >
                        {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                            <React.Fragment>
                                ...
                                <Text style={{ alignSelf: 'center', textAlign: 'center', marginHorizontal: 40, marginBottom: 10 }}>Please enter the OTP recieived on your email address.</Text>
                                <View style={{ flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginBottom: 25 }}>
                                    <View style={{
                                        alignSelf: 'center',
                                        borderColor: '#e6e6e6',
                                    ...
                                    {touched.newPassword && errors.newPassword && (
                                        <Text style={styles.errorText}>
                                            {touched.newPassword && errors.newPassword}</Text>)}
                                    <View style={{
                                        alignSelf: 'center',
                                        borderColor: '#e6e6e6',
                                        borderWidth: 1,
