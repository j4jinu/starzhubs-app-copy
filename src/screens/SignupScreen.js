...
import { ScrollView, View, TouchableOpacity, StyleSheet, TextInput, Text, SafeAreaView, ActivityIndicator } from 'react-native';
...
const SignupScreen = (props) => {
    ...
    const register = async (values, { setSubmitting }) => {
        ...
        try {
            ...
            alert('We are unable to process your request now. Please try again later.')
        }
    }
                    ...
                    {({
                        ...
                        values
                            ...
                            <>
                                ...
                                {touched.name && errors.name && <Text style={styles.errorText}>
                                ...
                                {touched.email && errors.email && <Text style={styles.errorText}>
                                ...
                                {touched.phone && errors.phone && <Text style={styles.errorText}>
                                ...
                                {touched.confPassword && errors.confPassword && <Text style={styles.errorText}>
