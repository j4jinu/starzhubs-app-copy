        ...
        <ScrollView>
            <View style={{ flex: 1 }}>
                ...
                <View
                    ...
                    <View
                        style={{ flexDirection: 'row', width: '100%', marginTop: '3%' }}>
                        <MoIcon name="mobile-phone"
                            size={25}
                            color={theme.$primaryColor}
                            style={{
                        ...
                        <View style={{ flexDirection: 'column' }}>
                            <Text style={{ marginLeft: '7%', color: 'gray' }}>+91 89218 13557</Text>
                            <Text style={{ marginLeft: '7%', color: 'gray' }}>For any queries</Text>
                        </View>
                    </View>
                    <View
                        style={{ flexDirection: 'row', width: '100%', marginTop: '3%' }}>
                        <EmIcon name="email-open"
                            size={20}
                            color={theme.$primaryColor}
                            style={{
                ...
                <View
                    ...
                    <Snackbar
                        ...
                        action={{}}>Enquiry has been submitted</Snackbar>
                    <Formik
                        ...
                        {({
                            ...
                            isValid,
                                ...
                                <>
                                    ...
                                    {errors.message && (<Text style={{ fontSize: 10, color: 'red' }}>{errors.message}</Text>)}
                                    <TouchableOpacity onPress={handleSubmit} disabled={!isValid} style={styles.SignupBtn}><Text
                                        style={{ color: 'white', textAlign: 'center' }}>Submit</Text>
                                    </TouchableOpacity>
                                </>
                            )}
                    </Formik>
