        ...
        <ScrollView style={styles.container}>
            {talents.map(t => (
                <>
                    ...
                    >
                        <Text style={{fontWeight: 'bold', fontSize: 17}}>{t.category.title}</Text>
                     ...
                     >
                         {m.fileType === 'image' ?
                             ...
                             <WebView
                                 ...
                                 source={{
                                     uri: 'https://www.youtube.com/embed/' + m.file.substring(m.file.lastIndexOf("=") + 1)
                                 }}
                             />
                         }
                         {/* <Image
                         ...
                         <Text style={styles.mediaDescription} numberOfLines={3}>{m.caption}</Text>
                     </TouchableOpacity>
                    ))}
                </>
            ))}
