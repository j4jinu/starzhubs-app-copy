...
import { ActivityIndicator, StyleSheet, Image, Text, TouchableOpacity, View, Alert } from 'react-native';
...
const MyPosterGridItem = (props) => {
    ...
    const confirmDelete = (pid) =>
        Alert.alert('Delete poster', 'Are you sure to delete this poster',
            [
                {
                    text: 'CANCEL',
                            ...
                            <View style={{ flex: 1, flexDirection: "row", justifyContent: 'space-between', paddingHorizontal: 15 }}>
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    <TouchableOpacity
                                        ...
                                        onPress={() => props.navigation.navigate('EditPoster', {
                                            posterId: props.id,
                                            title: props.poster,
                                            image: props.image,
                                            description: props.description,
