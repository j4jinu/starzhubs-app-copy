            ...
            >
                {props.media[0].fileType === 'image' ?
                    ...
                    <WebView
                        ...
                        source={{
                            uri: 'https://www.youtube.com/embed/' + props.media[0].file.substring(props.media[0].file.lastIndexOf("=") + 1)
                        }}
                    />
                }
                {/* <Image
                ...
                <Text style={styles.mediaDescription} numberOfLines={3}>{props.media[0].caption}</Text>
                <Text style={{ color: theme.$primaryColorText, marginLeft: 10 }}>Posted by: <Text style={styles.mediaAuthor}>{props.user[0].name}</Text></Text>
            </TouchableOpacity>
        </>
    );
};
